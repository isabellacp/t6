		...
		try {
			...
			case 2:
				...
				while (_la==T__7) {
					...
					((Parcela_unarioContext)_localctx).exp2.add(((Parcela_unarioContext)_localctx).expressao);
					}
					}
					setState(488);
					_errHandler.sync(this);
			...
			case 5:
				...
				match(T__21);
				setState(494);
				((Parcela_unarioContext)_localctx).exp3 = expressao();
				setState(495);
				match(T__22);
				}
				break;
